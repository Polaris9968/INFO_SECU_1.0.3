...
if(COPROTO_ENABLE_BOOST)
    ...
    macro(FIND_BOOST)
        ...
        find_package(Boost 1.83.0 COMPONENTS system thread regex ${ARGS} ${COPROTO_FIND_PACKAGE_OPTIONS})
    endmacro()
    ...
    if(NOT Boost_FOUND)
        message(FATAL_ERROR "Failed to find boost 1.83. When building coproto, add -DCOPROTO_FETCH_BOOST=ON or -DCOPROTO_FETCH_AUTO=ON to auto download.")
    endif()
