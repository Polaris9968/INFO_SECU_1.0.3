...
def _run_spso_mode(group_id, data_dir_attr, spso_mode,
    ...
    Args:
      group_id: 小组 ID
      data_dir_attr: Config 上的数据目录属性名(如 'KUNLUN_PSI_DATA_DIR')
...
class SpsoPSIMatch(KunlunRunner):
    ...
    receiver_exec = 'spso_runner'
    sender_exec = 'spso_runner'
    data_dir_attr = 'KUNLUN_PSI_CARD_DATA_DIR'   # PSI-Match 复用 PSI-Card 目录
    ...
    def run(cls, group_id):
        ...
        try:
            ...
            if os.path.exists(group_json_path):
                ...
                mgr_paths = {
                    'KUNLUN_PSI_CARD_DATA_DIR': 'psi_card_groups.json',
                }
